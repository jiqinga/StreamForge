        ...
        <NGrid responsive="screen" item-responsive>
          ...
          <NFormItemGi v-if="showLayout" span="24 m:12" :label="$t('page.manage.menu.layout')" path="layout">
            <NSelect v-model:value="model.layout" :options="layoutOptions"
              :placeholder="$t('page.manage.menu.form.layout')" filterable clearable />
          </NFormItemGi>
          ...
          <NFormItemGi span="24 m:12" :label="$t('page.manage.menu.icon')" path="icon">
            ...
            <template v-if="model.iconType === '2'">
              <NSelect v-model:value="model.icon" :placeholder="$t('page.manage.menu.form.localIcon')"
                :options="localIconOptions" filterable clearable />
            </template>
          </NFormItemGi>
          <NFormItemGi span="24 m:12" :label="$t('page.manage.common.statusType._')" path="status">
          ...
          <NFormItemGi v-if="model.hideInMenu" span="24 m:12" :label="$t('page.manage.menu.activeMenu')"
            path="activeMenu">
            <NSelect v-model:value="model.activeMenu" :options="pageOptions"
              :placeholder="$t('page.manage.menu.form.activeMenu')" filterable clearable />
          </NFormItemGi>

          ...
          <NGrid responsive="screen" item-responsive>
            ...
            <NFormItemGi span="24 s:12 m:6" :label="$t('page.manage.user.userGender')" path="userGender"
              ...
              <NSelect v-model:value="model.userGender" :placeholder="$t('page.manage.user.form.userGender')"
                :options="translateOptions(userGenderOptions)" filterable clearable />
            </NFormItemGi>
            ...
            <NFormItemGi span="24 s:12 m:6" :label="$t('page.manage.common.statusType._')" path="status"
              class="pr-24px">
              <NSelect v-model:value="model.statusType" :placeholder="$t('page.manage.common.statusType._')"
                :options="translateOptions(statusTypeOptions)" clearable />
            </NFormItemGi>

            <NFormItemGi span="24 s:12 m:6" :label="$t('page.manage.user.userRole')" path="roles" class="pr-24px">
              <NSelect v-model:value="model.byUserRoleCodeList" :options="roleOptions"
                :placeholder="$t('page.manage.user.form.userRole')" filterable clearable />
            </NFormItemGi>

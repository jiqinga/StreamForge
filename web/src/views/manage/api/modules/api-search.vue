    ...
    <NForm ref="formRef" :model="model" label-placement="left" :label-width="80">
      <NGrid responsive="screen" item-responsive>
        <NFormItemGi span="24 s:12 m:6" :label="$t('page.manage.api.method')" path="method" class="pr-24px">
          <NSelect v-model:value="model.apiMethod" :placeholder="$t('page.manage.api.form.method')"
            :options="translateOptions(apiMethodOptions)" filterable clearable />
        </NFormItemGi>
        ...
        <NFormItemGi span="24 s:12 m:6" :label="$t('page.manage.common.statusType._')" path="status" class="pr-24px">
          <NSelect v-model:value="model.statusType" :placeholder="$t('page.manage.common.statusType._')"
            :options="translateOptions(statusTypeOptions)" filterable clearable />
        </NFormItemGi>
